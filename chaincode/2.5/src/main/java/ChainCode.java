...
public class ChainCode implements ContractInterface {
    ...
    @Transaction
    public static QueryResultList queryAllByKey(final Context ctx, final String key,int index0,int index1){
        return InvokingMethod.queryAllByKey(ctx,key,index0,index1);
    }
