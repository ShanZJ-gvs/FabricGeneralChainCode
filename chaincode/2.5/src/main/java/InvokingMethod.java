...
public class InvokingMethod {
    ...
    @Transaction()
    public static QueryResultList queryAllByKey(final Context ctx, String key,int index0,int index1) {
        ChaincodeStub stub = ctx.getStub();
        final String startKey = key+index0;
        final String endKey = key+index1;
        QueryResultList resultList = new QueryResultList();
